var w = zakodixnet_canvas.width = window.innerWidth,
		h = zakodixnet_canvas.height = window.innerHeight,
		ctx = zakodixnet_canvas.getContext( '2d' ),
...
window.addEventListener( 'resize', function(){
	...
	opts.vanishPoint.x = ( w = zakodixnet_canvas.width = window.innerWidth ) / 2;
	opts.vanishPoint.y = ( h = zakodixnet_canvas.height = window.innerHeight ) / 2;
	ctx.fillRect( 0, 0, w, h );
});
